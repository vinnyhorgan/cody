---
name: skill-creator
description: Create or update skills for Cody. Use when designing, structuring, or packaging skills with scripts, references, and assets.
---
...
Create the skill directory and initial SKILL.md:

```bash
mkdir -p ~/.cody/workspace/skills/<skill-name>
```

Then create the SKILL.md with proper YAML frontmatter containing `name` and `description` fields. Optionally create subdirectories for `scripts/`, `references/`, and `assets/` as needed.
...
Once development of the skill is complete, test it on real tasks to verify it works as expected.
